// Mara AI — design tokens (mirrors mara-screens.jsx X object)
export const X = {
  ink:      '#0A0717',
  ink2:     '#13102A',
  ink3:     '#1B1638',
...
export const FUI = '"Plus Jakarta Sans", "Inter", system-ui, sans-serif'
export const FED = '"Plus Jakarta Sans", "Inter", system-ui, sans-serif'
